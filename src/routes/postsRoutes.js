...
import { listPosts, createNewPosts, uploadImagem, refreshNewPosts } from "../controller/postsController.js"; // Importa as funções controladoras para lidar com a lógica dos posts
...
const routes = (app) => {
  ...
  app.get("/posts", listPosts); // Chama a função controladora apropriada

  // Rota para criar um novo post
  app.post("/posts", createNewPosts); // Chama a função controladora para criação de posts

  // Rota para upload de imagens (assumindo uma única imagem chamada "imagem")
  app.post("/upload", upload.single("imagem"), uploadImagem); // Chama a função controladora para processamento da imagem`

  app.put("/upload/:id", refreshNewPosts)
};
